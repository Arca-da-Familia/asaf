...
from app.routers import auth, core, associados, financeiro, governanca, projetos, admin_portal, filiacao, importacao, situacao, voluntariado, qualidade_cadastro, estatuto, mandatos, sessao_assembleia, votacao
